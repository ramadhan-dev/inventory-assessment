...
fresh-install: 
	...
	@$(MAKE) up-build wait-db install key permission migrate filament-install sanctum-install livewire-install tailwind-install npm-build seed filament-assets filament-user seed-production
